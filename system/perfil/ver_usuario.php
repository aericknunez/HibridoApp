...
$perfil = new Perfiles();
  ...
  if ($r = $db->select("*", "perfil", "WHERE username = '".$_GET["username"]."'")) { 
      ...
      <section id="about" class="section-padding">
            <div class="container">
                <div class="row">
                   ...
                   <?php 
                  $foto = $perfil->GetFotoPerfil($_GET["username"]);
                  ...
                  <div>
                    <div class="text-center">Documentos de Identidad</div>
                      <?php 
                        if($perfil->CompruebaDoc($_GET["username"], 1) == TRUE){
                          Alerts::Mensajex("Existe Documento adjuntado","success",null,NULL);
                        } 
                        if($perfil->CompruebaDoc($_GET["username"], 2) == TRUE){
